...
export class HomeComponent implements OnInit {
  ...
  cards: CardTextImageModel[] = [
    {
      image: '../assets/bottom-image/IMG2.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"
    },
    {
      image: '../assets/bottom-image/IMG3.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"

    },
    {
      image: '../assets/bottom-image/IMG4.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"
    },
    {
      image: '../assets/bottom-image/IMG5.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"
    },
    {
      image: '../assets/bottom-image/IMG6.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"

    },
    {
      image: '../assets/bottom-image/IMG7.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"
    },
    {
      image: '../assets/bottom-image/IMG8.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"
    },
    {
      image: '../assets/bottom-image/IMG9.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"
    },
    {
      image: '../assets/bottom-image/IMG1.JPG',
      imageName: ' ',
      customStyle: "img-custom-size"
    }];
  ...
  ngOnInit(): void {
    this.imageMapHashMap.set(1, {
      image: '../assets/map-images/Map_1.JPG',
